		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#cotemarsolicitudprontospagos-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cotemarsolicitudprontospagos-display": {
								"semanticObject": "cotemarsolicitudprontospagos",
								"action": "display",
								"description": "Aplicacion para creacion de solicitudes prontos pagos",
								"title": "App Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cotemar.solicitudprontospagos",
									"url": sap.ui.require.toUrl("cotemar/solicitudprontospagos")
								}
							}
						}
					}
